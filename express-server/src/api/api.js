...
const app = express(); //do I need this for app.delete()
...
app.delete('/api/v1/:model', (req,res) => {
  if ( req.query.id ) {
    console.log('Hi from delete method at api.js')
    req.model.deleteOne(req.query.id)
      .then(data => sendJSON(res, data))
      .catch(err => serverError(res, err));
  }
});
